    ...
    if (e.getSource() == submit) {
      if (idt.getText().equals("") || namet.getText().equals("") || greditt.getText().equals("")
        ...
        if (hasCourse(idt.getText()) == 1) {
          ...
          File gradeFile = new File(new File(System.getProperty("user.dir")).getParent() + "/data/grade" + course.getCourseName() + ".txt");
          File studentFile = new File(
              new File(System.getProperty("user.dir")).getParent() + "/data/course_student" + course.getCourseName() + "_student.txt");
