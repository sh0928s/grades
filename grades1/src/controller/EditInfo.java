			...
			if ((inst.getText().equals("")) || (birtht.getText().equals(""))
				...
				if (!(pass1t.getText().equals(pass2t.getText()))) {
					...
					if (flag == 0) { // 学生修改信息
						...
						String file = new File(System.getProperty("user.dir")).getParent()+ "/data/student.txt";
						...
						ArrayList<String> modifiedContent = new ArrayList<String>();
						String file = new File(System.getProperty("user.dir")).getParent()+ "/data/teacher.txt";
						...
						ArrayList<String> modifiedContent = new ArrayList<String>();
						String file = new File(System.getProperty("user.dir")).getParent()+"/data/administrator.txt";
